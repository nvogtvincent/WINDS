...
#  elif defined  BENGUELA_LR
      parameter (LLm0=249,   MMm0=154,   N=32)   ! BENGUELA_LR
...
#  elif defined WIOInterannual
      parameter (LLm0=2143,  MMm0=1209,  N=50)   ! WIOInterannual
#  else
...
!
      ...
      parameter (NP_XI=63, NP_ETA=32,  NNODES=NP_XI*NP_ETA)
      parameter (NPP=1)
...
# ifdef CFB_STRESS
      ...
      parameter (cfb_slope=-0.0025)
      parameter (cfb_offset=0.013)
